...
public:
    ...
    void setupUi(QWidget *XRtmpStreamerClass)
    {
        ...
        XRtmpStreamerClass->resize(678, 267);
...
"}"));
        ...
        outUrl->setGeometry(QRect(170, 30, 481, 41));
        label = new QLabel(XRtmpStreamerClass);
        label->setObjectName(QStringLiteral("label"));
        label->setGeometry(QRect(30, 40, 111, 21));
        ...
        inUrl->setGeometry(QRect(170, 80, 481, 41));
        startButton = new QPushButton(XRtmpStreamerClass);
        startButton->setObjectName(QStringLiteral("startButton"));
        startButton->setGeometry(QRect(270, 150, 111, 61));
        ...
        face->setGeometry(QRect(140, 160, 81, 31));
    ...
    void retranslateUi(QWidget *XRtmpStreamerClass)
    {
        ...
        outUrl->setText(QApplication::translate("XRtmpStreamerClass", "rtmp://192.168.0.130/live", Q_NULLPTR));
        label->setText(QApplication::translate("XRtmpStreamerClass", "\346\216\250\346\265\201RTMP URL:", Q_NULLPTR));
        label_2->setText(QApplication::translate("XRtmpStreamerClass", "\350\276\223\345\205\245\347\232\204URL\346\210\2260,1:", Q_NULLPTR));
